...
mongoose.Error.messages.Number.min = "O '{VALUE}' informado é menor que o limite mimino de '{MIN}'." 
mongoose.Error.messages.Number.max = "O '{VALUE}' informado é maior que o limite maximo de '{MAX}'." 
mongoose.Error.messages.toString.enum = "'{VALUE}' não é permitido para o atributo '{PATH}.'"